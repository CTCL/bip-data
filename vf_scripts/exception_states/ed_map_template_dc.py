...
ed_map.update(dict([('{state} State Legislature District {number}'.format(state=state[0], number=(int(n) if intpat.match(n) else n)).lower(),{'name':n,'type':'state_rep_district'}) for n in state_representative_district]))
ed_map.update(dict([('{state} Legislative District {number}'.format(state=state[0], number=(int(n) if intpat.match(n) else n)).lower(),{'name':n,'type':'state_rep_district'}) for n in state_representative_district]))
...
ed_map.update(dict([('{state} - Ward {number}'.format(state=state[0], number=int(n)).lower(),{'name':n,'type':'ward'}) for n in ward]))
...
ed_map.update(dict([('State Legislature District {number}'.format(number=(int(n) if intpat.match(n) else n)).lower(),{'name':n,'type':'state_rep_district'}) for n in state_representative_district]))
ed_map.update(dict([('Legislative District {number}'.format(number=(int(n) if intpat.match(n) else n)).lower(),{'name':n,'type':'state_rep_district'}) for n in state_representative_district]))
