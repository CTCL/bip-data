...
for county in county_council:
    ...
    for f in fillers:
        ...
        for k,v in special_ia_bs.iteritems():
            county_council_dicts.append(('{county_name} {filler} {district_letters}'.format(filler=f,county_name=v['cn'], district_letters=v['n']).lower(),{'name':k,'type':'county_council'}))
